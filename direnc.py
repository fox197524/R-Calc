...
class ResistorCalculator(QWidget):
    def __init__(self):
        ...
        ana_layout.addWidget(QLabel("Bant Sayısı Seç:"))
        ...
        self.author_label = QLabel("by fox")
    ...
    def refresh_band_setup(self):
        ...
        etiketler = ["1. Basamak", "2. Basamak", "3. Basamak", "Çarpan", "Tolerans", "Sıcaklık Katsayısı"]
        self.combo_boxes = []
    ...
    def calculate_resistor(self):
        try:
            ...
            self.result_label.setText("Hata: Girişler geçersiz.")
